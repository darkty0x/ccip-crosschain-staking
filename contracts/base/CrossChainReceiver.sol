...
/// @title - Stake Across Protocol Contract for sending/receiving messages and tokens across chains.
/// @notice - Pay using LINK tokens
/// @dev - This contract inherits from CCIPReceiver and OwnerIsCreator
...
contract CrossChainReceiver is CCIPReceiver, OwnerIsCreator {
    ...
    /// @notice This function sends a message to another chain.
    /// @dev This function sends a message to another chain.
    /// @param destinationChainSelector the chain selector of the destination chain
    /// @param receiver the address of the receiver on the destination chain
    /// @param tokenToTransfer the token to be transferred
    ...
    function sendMessage(
        ...
        Client.EVM2AnyMessage memory evm2AnyMessage = Client.EVM2AnyMessage({
            ...
            data: abi.encode(sender), // ABI-encoded sender message
